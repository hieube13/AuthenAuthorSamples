    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser { UserName = Input.Email, Email = Input.Email, Address = Input.Address, CompanyStartedDate = Input.CompanyStartedDate };
                ...
                if (result.Succeeded)
                {
                    ...
                    _logger.LogInformation("User created with Date Of Birth Claim");
